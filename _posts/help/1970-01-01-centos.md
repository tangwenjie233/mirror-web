...
之后启用重庆大学软件仓库， 将以下内容写入 /etc/yum.repos.d/CentOS-Base.repo
...
baseurl=https://mirrors.cqu.edu.cn/centos/$releasever/os/$basearch/
...
baseurl=https://mirrors.cqu.edu.cn/centos/$releasever/updates/$basearch/
...
baseurl=https://mirrors.cqu.edu.cn/centos/$releasever/extras/$basearch/
...
baseurl=https://mirrors.cqu.edu.cn/centos/$releasever/addons/$basearch/
...
baseurl=https://mirrors.cqu.edu.cn/centos/$releasever/centosplus/$basearch/
...
baseurl=https://mirrors.cqu.edu.cn/centos/$releasever/contrib/$basearch/
